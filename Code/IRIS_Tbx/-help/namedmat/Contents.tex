 ...
 functions, such as \href{model/acf}{model/acf},
 \href{model/xsf}{model/xsf}, or \href{model/fmse}{model/fmse}, to
 facilitate easy selection of submatrices by referrring to variable names
 in rows and columns.
 ...
 \paragraph{Manipulating named matrices}
 ...
 \paragraph{Getting row and column names}
