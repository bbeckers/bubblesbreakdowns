 ...
 \item
   ...
   \emph{\texttt{100 freq\^{}2}} {]} - Smoothing parameter; needs to be
   specified for tseries objects with indeterminate frequency.
 \item
 ...
 \subparagraph{The underlying optimisation problem}
 ...
 of the input time series as $\lambda = 100 \cdot f^2$, where $f$ is the
