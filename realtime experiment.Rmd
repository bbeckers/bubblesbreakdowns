...
# setting some values
horizon=13 # inflation is published with on month lag.
target='PCPIX' # core inflation
max.lag=12 # maximum lag length to be considered 
max.obs=60 # maximum number of past observations to be considered.
...
# dropping "MCOILWTICO" as it is too short (starting in 1986)
...
for (vint.num in 1:length(sets)){
        ...
        colnames(set)[grep(paste(target,'_chg_12',sep=''),colnames(set))]='infl'
